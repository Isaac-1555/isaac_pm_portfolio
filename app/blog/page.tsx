...
const posts = [
  ...
  },
  {
    ...
    readTime: "10 min",
    author: "Isaac",
    tags: ["Chrome Extension", "Supabase", "Internal Tool", "Realtime"],
    image: "/BarcodeLists_1.png",
    gradient: "from-slate-800 to-slate-950",
  },
  {
    slug: "d4c",
    title: "D4C: Building a Terminal Coding Agent in Rust from Scratch",
    subtitle:
    ...
    readTime: "8 min",
    author: "Isaac",
    tags: ["Rust", "AI", "Dev Tools", "Open Source", "Agent", "MCP"],
...
export default function BlogPage() {
  ...
  const projects = revealProps(reduced);
  ...
  return (
    <div className="container mx-auto px-4 py-24">
      ...
      <motion.section
        ...
        id="mission-blog-projects"
        className="will-change-transform mb-24"
      >
