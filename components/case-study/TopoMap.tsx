...
export function TopoMap({ activeId }: { activeId?: string }) {
  return (
    <div className="absolute inset-0 z-0 pointer-events-none" aria-hidden="true">
      <div
        className="absolute inset-0 bg-[url('/topographic.svg')] bg-no-repeat bg-[center_top] [background-size:cover] opacity-60 [filter:brightness(1.8)_contrast(1.4)] md:[background-size:100%_auto] md:opacity-40 md:[filter:none]"
      />
