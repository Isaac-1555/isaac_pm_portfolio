...
export function FeaturedWork() {
  return (
    <section className="py-24 bg-bg-base/50">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-industrial font-bold uppercase tracking-widest text-text-primary">
          ...
          {projects.map((project) => (
            <Card key={project.id} className="group h-full flex flex-col hover:border-cta transition-colors">
              <div className={`h-48 w-full bg-gradient-to-br ${project.gradient} relative overflow-hidden flex items-center justify-center`}>
                ...
                <project.icon className="h-16 w-16 text-white/20 group-hover:text-white/40 transition-colors transform group-hover:scale-110 duration-500" />
