...
const projects = [
  ...
  },
  {
    ...
    description: "Owned end-to-end delivery for B2B workflow initiatives. Improved workflow completion rates through stakeholder management.",
    metrics: ["+25% Efficiency", "15+ Interviews"],
    tags: ["B2B", "Workflow", "Stakeholders"],
    href: "/work",
