...
export const ASSET_MANIFEST: Record<AssetKey, AssetConfig> = {
  ...
  'player-engine-sheet': { src: 'player-engines/base-sheet.png', fw: 48, fh: 48, frames: 4, fps: 8, loop: true, cols: 4 },
  ...
  'shield-round': { src: 'shields/round.png', fw: 32, fh: 32, frames: 24, fps: 12, loop: true, cols: 24 },
  'shield-front': { src: 'shields/front.png', fw: 32, fh: 32, frames: 20, fps: 12, loop: true, cols: 20 },
  'shield-front-side': { src: 'shields/front-side.png', fw: 32, fh: 32, frames: 12, fps: 12, loop: true, cols: 12 },
  'shield-invincibility': { src: 'shields/invincibility.png', fw: 32, fh: 32, frames: 20, fps: 12, loop: true, cols: 20 },
